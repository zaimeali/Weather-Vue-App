...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    fetchedData: function fetchedData() {
      ...
      fetch("http://127.0.0.1:8000/api/weather?cityName=".concat(this.location.name)).then(function (response) {
        return response.json();
      }).then(function (data) {
        console.log(data);
        _this.currentTemperature.actual = data.main.temp;
        _this.currentTemperature.feelsLike = data.main.feels_like;
...
var render = function() {
  ...
  return _c("div", { staticClass: "text-white mb-8" }, [
    ...
    _c(
      ...
      {
        staticClass:
          "weather-container font-sans max-w-lg overflow-hidden bg-gray-900 shadow-lg mt-4 rounded-lg"
      },
      [
        _c(
          "div",
        ...
        _c("div", { staticClass: "flex items-center" }, [
          ...
          _c("div", { staticClass: "w-4/6 px-4 flex items-center" }, [
            ...
            _c("div", { staticClass: "ml-3" }, [
              _vm._v("Cloudy with a chance of rain")
            ])
          ]),
          _vm._v(" "),
